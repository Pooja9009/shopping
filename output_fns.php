        ...
        <tr>
            <td rowspan="2">
                <a href="index.php"><img src="images/Book-O-Rama.gif" alt="Bookorama" border="0" align="left"
                                         align="bottom" height="55" width="325"></a>
            </td>
    ...
    <table border="0" width="100%" cellspacing="0">
        <form action="purchase.php" method="post">
            ...
            <tr>
                <td>Name</td>
                <td><label>
                        <input type="text" name="name" value="" maxlength="40" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>Address</td>
                <td><label>
                        <input type="text" name="address" value="" maxlength="40" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>City/Suburb</td>
                <td><label>
                        <input type="text" name="city" value="" maxlength="20" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>State/Province</td>
                <td><label>
                        <input type="text" name="state" value="" maxlength="20" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>Postal Code or Zip Code</td>
                <td><label>
                        <input type="text" name="zip" value="" maxlength="10" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>Country</td>
                <td><label>
                        <input type="text" name="country" value="" maxlength="20" size="40">
                    </label></td>
            </tr>
            ...
            <tr>
                <td>Name</td>
                <td><label>
                        <input type="text" name="ship_name" value="" maxlength="40" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>Address</td>
                <td><label>
                        <input type="text" name="ship_address" value="" maxlength="40" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>City/Suburb</td>
                <td><label>
                        <input type="text" name="ship_city" value="" maxlength="20" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>State/Province</td>
                <td><label>
                        <input type="text" name="ship_state" value="" maxlength="20" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>Postal Code or Zip Code</td>
                <td><label>
                        <input type="text" name="ship_zip" value="" maxlength="10" size="40">
                    </label></td>
            </tr>
            <tr>
                <td>Country</td>
                <td><label>
                        <input type="text" name="ship_country" value="" maxlength="20" size="40">
                    </label></td>
            </tr>
            <tr>
    ...
    <table border="0" width="100%" cellspacing="0">
        <form action="process.php" method="post">
            ...
            <tr>
                <td>Type</td>
                <td>
                    <label for=""></label><select name="card_type" id="">
